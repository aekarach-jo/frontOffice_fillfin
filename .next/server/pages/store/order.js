...
;// CONCATENATED MODULE: ./components/store/order/collapse.js
...
;// CONCATENATED MODULE: ./components/store/order/storeOrder.js
...
const storeOrder_apiUrl = (next_config_default()).apiPath;
function StoreOrder() {
    ...
    async function getOrder() {
        ...
        const apiGetOrder = await external_axios_default()({
            method: "GET",
            url: `${storeOrder_apiUrl}/api/store/orders/get`,
            headers: {
                Authorization: `Bearer ${access_token}`
            }
        });
    ...
    async function getAllProduct() {
        ...
        const getAll = await external_axios_default()({
            method: "GET",
            url: `${storeOrder_apiUrl}/api/member/getOrder`,
            headers: {
                Authorization: `Bearer ${access_token}`
            }
        }).then((res)=>{
...
;// CONCATENATED MODULE: ./pages/store/order.js
...
function order() {
    return /*#__PURE__*/ jsx_runtime_.jsx(external_react_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx(StoreOrder, {})
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [377,964,675,143,760], () => (__webpack_exec__(3792)));
